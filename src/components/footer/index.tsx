...
import {FaCopyright, FaFacebook, FaInstagram, FaIntercom, FaPhone, FaTelegram} from "react-icons/fa";
              ...
              <div className="footer__column">
                <div className="footer__logo-wrap">
                  ...
                  <div className="">
                    ...
                    <p className='footer__logo-subTitle'>Интернет магазинстрой материалов</p>
                  </div>
