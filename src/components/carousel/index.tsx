    ...
    <Carousel className='w-100'>
      <Carousel.Item interval={3000} className='w-100'>
        ...
        <Carousel.Caption>
          ...
          <p>
            пастообразный или порошковый материал, применяемый для выравнивания
            поверхностей перед нанесением на них материалов для отделки
            помещений. Шпаклёвками называют составы, применяемые для
      ...
      <Carousel.Item interval={3000}>
        ...
        <Carousel.Caption>
          ...
          <p>
            ...
            слоёв строительной бумаги (картона) и сердечника из слоя
      ...
      <Carousel.Item interval={3000}>
        ...
        <Carousel.Caption>
          ...
          <p>
            многослойный строительный материал, изготавливаемый путём склеивания
            специально подготовленного шпона. Для повышения прочности фанеры
            слои шпона накладываются так.
          </p>
        </Carousel.Caption>
      </Carousel.Item>
    </Carousel>
